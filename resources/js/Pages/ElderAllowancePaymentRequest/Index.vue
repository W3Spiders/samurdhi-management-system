<template>
    <div>
        <Head title="Elder Allowance Payment Requests" />
        ...
        <div class="flex items-center justify-between mb-6">
            ...
            <Link
                v-if="auth.user.user_type === 'gn'"
                class="btn btn-primary"
                :href="route('elder_allowance_payment_requests.create')"
            >
                <span>Add</span>
            </Link>
        </div>
        ...
        <div class="bg-white rounded-md shadow overflow-x-auto">
            <table class="w-full whitespace-nowrap">
                ...
                <tr
                    v-for="payment_request in elder_allowance_payment_requests.data"
                ...
                <tr v-if="elder_allowance_payment_requests.data.length === 0">
                    <td class="px-6 py-4 border-t" colspan="4">
                        No elder allowance payment requests found.
                    </td>
                </tr>
            </table>
        </div>
        ...
        <pagination
            class="mt-6"
            :links="elder_allowance_payment_requests.links"
        />
    </div>
</template>
...
export default {
    ...
    props: {
        auth: Object,
        filters: Object,
        elder_allowance_payment_requests: Object,
    },
    data() {
        return {
            form: {
    ...
    watch: {
        form: {
            ...
            handler: throttle(function () {
                this.$inertia.get(
                    "/elder-allowance-payment-requests",
                    pickBy(this.form),
                    {
                        preserveState: true,
                    }
