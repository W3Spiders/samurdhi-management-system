        ...
        <div class="md:flex md:flex-col">
            <div class="md:flex md:flex-col md:h-screen">
                <div class="md:flex md:flex-shrink-0">
                    <div
                        class="flex items-center justify-between px-6 py-4 bg-slate-700 md:flex-shrink-0 md:justify-center md:w-56">
                ...
                <div class="md:flex md:flex-grow md:overflow-hidden">
                    <main-menu :auth="auth" class="hidden flex-shrink-0 p-12 w-56 bg-slate-800 overflow-y-auto md:block" />
                    <div class="bg-slate-100 px-4 py-8 md:flex-1 md:p-12 md:overflow-y-auto" scroll-region>
                        <flash-messages />
                        <slot />
                    </div>
                </div>
